...
try:
    ...
    # If USD-INR column exists, convert Price and Total to INR
    if usd_col:
        try:
    ...
    sheet_id = "15s9U7fAJw4Un4y3XV-xUnLe2hlkoFAZdzrUSexQ3he0"
    ...
    worksheet.update(f"A{start_row}", final_df.values.tolist())
